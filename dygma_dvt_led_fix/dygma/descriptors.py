...
from dygma_dvt_led_fix.auxillary_types import Palette, RGBW, VersionType 
from dygma_dvt_led_fix.constants import PALETTE_SIZE
from dygma_dvt_led_fix.dygma.utils import neuron_io, rgb2rgbw
